...
const socials = [
  {
    name: "Twitter",
    href: "https://twitter.com/NotGAspegic",
    Icon: RiTwitterXLine,
  },
  {
    name: "GitHub",
    href: "https://github.com/NotGAspegic",
    Icon: RiGithubLine,
  },
  {
    name: "LinkedIn",
  ...
  {
    name: "Email",
    href: "mailto:me@souhail.smiriaa@gmail.com",
    Icon: RiMailLine,
  },
];
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div className="flex gap-4 items-center flex-col">
          <div className="flex gap-4 items-center flex-row">
            <Avatar
              name="Souhail Smiri"
              src="/souhailsmiri.png"
              size="lg"
            />
            <div className="flex gap-2 items-center flex-col">
              <p className="text-4xl">Hi, I&apos;m Souhail</p>
